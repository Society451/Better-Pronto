from readjson import save_response_to_file, getdetailedbubbleoverview, create_bubble_folders
...
#keep create_bubble_folders for testing
...
#some more stuff to 1) get a bubble ID and 2) get messages from that bubble and then write the messages to the relevant folder folder/json file
