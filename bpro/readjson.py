    ...
    if bubbles:
        ...
        for category, bubble_list in categorizedgroups.items():
            ...
            if not os.path.exists(category_folder_path):
                ...
                print(f"Folder already exists for category {category}: {category_folder_path}")
        ...
        if not os.path.exists(uncategorized_folder_path):
            ...
            print(f"Folder already exists for Uncategorized bubbles: {uncategorized_folder_path}")
        ...
        if not os.path.exists(dm_folder_path):
            ...
            print(f"Folder already exists for DM bubbles: {dm_folder_path}")
